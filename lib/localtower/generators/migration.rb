  ...
  module Generators
    ...
    class Migration
      ...
      def initialize(migrations)
        ...
        pending_migration = Localtower::Status.new.run.select {|i| i['status'] == :todo}.any?

        raise "there is a pending migration" if pending_migration
      end
      ...
      def run
        ...
        cmd = "#{action_names}#{column_names}For#{model_names}"
